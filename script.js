...
const ITEMS = [
  ...
  {
    id: 'plnts-cert',
    name: 'PLNTS Gift Card',
    note: 'I would love to get a new plant.',
    url: 'https://plnts.com/de/',
    linkLabel: 'View PLNTS',
  ...
  {
    id: 'keychain',
    name: 'Keychain or Carabiner',
    note: 'Something in my palette — silver, white, or grey (no black, it won\'t stand out on me).',
    url: null,
    linkLabel: 'No link',
    icon: 'key',
  },
